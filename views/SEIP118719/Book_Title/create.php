    ...
    <body>
        ...
        <section class="create_book_area">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h2>Add your favorite Book Title...</h2>
                    </div>
                    <div class="col-md-12">
                        <form action="store.php" method="post">
                            <div class="row">
                                ...
                                <div class="col-md-10 text-left">
                                    <input type="text" name="book_title" autofocus="autofocus" placeholder="Enter your favorite book title..." required="required" tabindex="1" size="30"/>  
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-2">                                    
                                ...
                                <div class="col-md-10 text-left">
                                    <input type="text" name="author" autofocus="autofocus" placeholder="Enter author name..." required="required" tabindex="1" size="30"/>  
                                </div>
                            </div>
                            <div class="row">
