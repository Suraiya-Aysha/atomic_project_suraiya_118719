    ...
    <body>
        ...
        <section class="create_book_area">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h2>Update your Birthday Date...</h2>
                    </div>
                    <div class="col-md-12">
                        <form action="store.php" method="post">
                            <div class="row">
                                ...
                                <div class="col-md-10 text-left">
                                    <input type="text" id="name" name="name" autofocus="autofocus" placeholder="Enter your name..." required="required" tabindex="1" size="30"/>  
                                </div>
                            </div>    
                            <div class="row">
                                <div class="col-md-2">                                    
                                    <label for="title">User Birth Date:</label> 
                                </div>
                                <div class="col-md-9 text-left">
                                    <input type="date" id="date" name="date" autofocus="autofocus" placeholder="dd/mm/yy" required="required" tabindex="2" size="30"/>
                                </div>    
                            </div>
                            <div class="row">
