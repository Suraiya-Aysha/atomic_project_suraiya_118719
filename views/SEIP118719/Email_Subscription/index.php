...
$email_subscription_obj = new Email_Subscription();

$email_subscription_objs = $email_subscription_obj->index();
?>
<!DOCTYPE html>
<!--
...
<html>
    <head>
        ...
        <title>List Email Subscriber's</title>
        ...
        <section class="list_area">
            <div class="container">
                ...
                <div class="col-md-12 text-center">
                    <h2>All List of Email Subscribers...</h2>
                </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <table border="1">
                            <thead>
                                <tr>
                                    ...
                                    <th>First Name::</th>
                                    <th>Last Name:</th>
                                    <th>Email Address list   <a href="#"><i class="fa fa-arrow-down"></i></a></th>
                                    <th>Action</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <?php
                                $serial_no=1;
                                foreach($email_subscription_objs as $email_subscription_obj)
                                {
                                ?>
                                <tr>
                                    <td><?php echo $serial_no;?></td>
                                    <td><?php echo $email_subscription_obj->id;?></td>
                                    <td><?php echo $email_subscription_obj->first_name;?></td>
                                    <td><?php echo $email_subscription_obj->last_name;?></td>
                                    <td><a href="#"><?php echo $email_subscription_obj->email_subscription;?></a></td>
