...
<html>
    <head>
        ...
        <title>Create Email Subscription's Form</title>
    ...
    <body>
                        ...
                        <div class="book_menu">
                            <nav>
                                <ul>
                                    ...
                                    <li> <a href="index.php">Subscriber's List</a></li>
        ...
        <section class="create_book_area">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h2>Subscribe to receive Product's updates via email.</h2>
                    </div>
                    <div class="col-md-12">
                        <form action="store.php" method="post">
                            <div class="row">
                                ...
                                <div class="col-md-10 text-left">
                                    <input type="text" name="first_name" autofocus="autofocus" placeholder="Enter your name..." required="required" tabindex="1" size="30"/>  
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-2">                                    
                                ...
                                <div class="col-md-10 text-left">
                                    <input type="text" name="last_name" autofocus="autofocus" placeholder="Enter your name..." required="required" tabindex="1" size="30"/>  
                                </div>
                            </div>      
                            <div class="row">
                                <div class="col-md-2">                                    
                                    <label for="email_subscription">Email:</label> 
                                </div>
                                <div class="col-md-9 text-left">
                                    <input type="text" name="email_subscription" autofocus="autofocus" placeholder="Type Email to Subscribe" required="required" tabindex="2" size="30"/>
                                </div>    
                            </div>
                            <div class="row">
