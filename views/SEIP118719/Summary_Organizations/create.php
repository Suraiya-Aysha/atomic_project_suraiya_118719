...
<html>
    <head>
        ...
        <title>Create Organizations Summary</title>
    ...
    <body>
        ...
        <section class="create_book_area">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h2>Add your Organization's Summary...</h2>
                    </div>
                    <div class="col-md-12">
                        <form action="store.php" method="post">
                            <div class="row">
                                ...
                                <div class="col-md-10 text-left">
                                    <input type="text" name="company_name" autofocus="autofocus" placeholder="Enter your company name..." required="required" tabindex="1" size="30"/>                             
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-2">
                                    <label for="summary_organizations">Summary:</label>
                                </div>
                                <div class="col-md-10">
                                    <textarea name="summary_organizations" autofocus="autofocus" placeholder="Enter your company name..." required="required" tabindex="2" size="50">                                        
                                    </textarea>
                                </div>
                            </div> 
                            <div class="row">
