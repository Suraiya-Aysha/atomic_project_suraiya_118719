...
$summary_orga_obj=new Summary_Organizations();
$summary_orga_objs = $summary_orga_obj->index();
?>
...
<html>
    <head>
        ...
        <title>List of Organizations Summary</title>
                        ...
                        <div class="book_menu">
                            <nav>
                                <ul>
                                    ...
                                    <li> <a href="index.php">Summary List</a></li>
        ...
        <section class="list_area">
            <div class="container">
                ...
                <div class="col-md-12 text-center">
                    <h2>All Summary List of your Organization...</h2>
                </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <table border="1">
                            <thead>
                                <tr>
                                    ...
                                    <th>ID</th>
                                    <th>Company Name:</th>
                                    <th>Organization Summary<a href="#"><i class="fa fa-arrow-down"></i></a></th>
                                    <th>Action</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <?php
                                $serial_no=1;
                                foreach($summary_orga_objs as $summary_orga_obj)
                                {
                                ?>
                                <tr>
                                    <td><?php echo $serial_no;?></td>
                                    <td><?php echo $summary_orga_obj->id;?></td>
                                    <td><?php echo $summary_orga_obj->company_name;?></td>
                                    <td><a href="#"><?php echo $summary_orga_obj->summary_organizations;?></a></td>
